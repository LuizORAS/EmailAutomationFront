...
function ProductiveEmail() {
        ...
        const fetchEmails = async () => {
            try {
                ...
                if (response.data && Array.isArray(response.data.emails)) {
                    const filteredEmails = response.data.emails.filter(email => email.classification === 'important');
    ...
    return (
        <div className="all-emails-container">
            <h1 className="h1-allEmailcontainer">Aqui estão os emails produtivos</h1>
